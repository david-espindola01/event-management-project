  ...
  <div class="admin-shell">
    ...
    <aside class="sidebar">
      ...
      <div class="sidebar-footer">
        <NuxtLink to="/public" class="back-link">
...
.back-link { display: flex; align-items: center; gap: 7px; font-size: .78rem; color: #64748b; transition: color var(--transition); }
.back-link:hover { color: #94a3b8; }

/* ── Main ── */
.admin-main { flex: 1; padding: 32px; min-width: 0; overflow-y: auto; }
...
.section-title { font-size: 1.35rem; font-weight: 800; color: var(--text-primary); }
...
.empty-state-text { font-size: .88rem; color: var(--text-muted); }
